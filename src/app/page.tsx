...
export default function Home() {
  return (
    <div className="min-h-screen bg-[var(--page-bg)]">
      {/* Header */}
      <header className="bg-[var(--sidebar-bg)] border-b border-white/10">
        ...
        <section className="py-20 lg:py-28 flex flex-col lg:flex-row items-center gap-12 lg:gap-20">
          <div className="flex-1 text-center lg:text-left">
            ...
            <div className="mt-8 flex flex-col sm:flex-row gap-3 justify-center lg:justify-start">
              <Link
                href="/login"
                className="inline-flex justify-center items-center px-6 py-3 text-sm font-medium rounded-md text-white bg-[var(--primary)] hover:bg-[var(--primary-dark)] transition-colors shadow-sm"
              >
                Iniciar Evaluacion
                <svg
                  aria-hidden="true"
              ...
              <Link
                href="/admin/login"
                className="inline-flex justify-center items-center px-6 py-3 text-sm font-medium rounded-md text-[var(--text-primary)] bg-white border border-[var(--border-color)] hover:border-[var(--primary)] hover:text-[var(--primary)] transition-colors shadow-sm"
              >
          ...
          <div className="flex-1 flex justify-center">
            <div className="relative w-72 h-72 lg:w-96 lg:h-96">
              <div className="absolute inset-0 rounded-full bg-[var(--primary)]/5" />
              <div className="absolute inset-6 rounded-full bg-[var(--primary)]/10" />
              <div className="absolute inset-0 flex items-center justify-center">
                <div className="bg-white rounded-xl shadow-lg border border-[var(--border-color-light)] p-6 w-56 lg:w-64 space-y-4">
                  ...
                  <div className="space-y-2">
                    <div className="flex items-center gap-2">
                      ...
                      <div className="h-2 bg-[var(--border-color-light)] rounded flex-1" />
                    </div>
                    <div className="flex items-center gap-2">
                      <div className="w-3.5 h-3.5 rounded-full border-2 border-[var(--border-color)]" />
                      <div className="h-2 bg-[var(--border-color-light)] rounded w-3/4" />
                    </div>
                    <div className="flex items-center gap-2">
                      <div className="w-3.5 h-3.5 rounded-full border-2 border-[var(--border-color)]" />
                      <div className="h-2 bg-[var(--border-color-light)] rounded w-5/6" />
                    </div>
                  </div>
                  <div className="pt-2">
                    <div className="w-full h-1.5 bg-[var(--border-color-light)] rounded-full overflow-hidden">
                      <div className="h-full w-2/3 bg-[var(--primary)] rounded-full" />
                    </div>
      ...
      {/* Footer */}
      <footer className="border-t border-[var(--border-color-light)] bg-white">
