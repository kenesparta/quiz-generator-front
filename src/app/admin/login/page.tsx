      ...
      <div className="hidden lg:flex lg:w-1/2 bg-(--sidebar-bg) relative overflow-hidden">
        <div className="flex flex-col justify-center px-16 relative z-10">
          <div className="flex items-center gap-3 mb-8">
            ...
            <span className="text-white font-semibold text-xl">Quiz Admin</span>
          </div>
          ...
          <p className="text-white/60 text-lg max-w-md">
            Gestiona evaluaciones, exámenes, postulantes y revisiones desde un
            solo lugar.
          </p>
        </div>
        {/* Decorative circles */}
          ...
          <div className="bg-white rounded-lg shadow-[0_1px_2px_rgba(0,0,0,0.06)] border border-(--border-color-light) p-6">
            <form className="space-y-5" onSubmit={handleSubmit}>
              ...
              <button
                type="submit"
                disabled={isLoading}
                className="w-full flex justify-center py-2.5 px-4 text-sm font-medium rounded-md text-white bg-(--primary) hover:bg-(--primary-dark) focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-(--primary) disabled:opacity-50 disabled:cursor-not-allowed cursor-pointer transition-colors"
              >
                {isLoading ? (
